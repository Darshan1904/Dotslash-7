            ...
            (function (t) {
                ...
                !(function () {
                    ...
                    r.prototype = {
                            ...
                            if (
                                ...
                                for (var i = 0; i < n._howls.length; i++)
                                    if (!n._howls[i]._webAudio)
                                        for (
                                            var t = n._howls[i]._getSoundIds(),
                                                o = 0;
                                            o < t.length;
                                            o++
                                        ) {
                                            var r = n._howls[i]._soundById(
                                                t[o]
                                            );
                                            r &&
                                                r._node &&
                        ...
                        unload: function () {
                            for (
                                var e = this || d, i = e._howls.length - 1;
                                i >= 0;
                                i--
                            )
                                e._howls[i].unload();
                    ...
                    _.prototype = {
                        ...
                        play: function (e, n) {
                            ...
                            if (o && !_._paused)
                                return n || t._loadQueue("play"), _._id;
                            ...
                            var c = Math.max(
                                ...
                                f = Math.max(
                                    0,
                                    (t._sprite[e][0] + t._sprite[e][1]) / 1e3 -
                                        c
                                ),
                        ...
                        _cleanBuffer: function (e) {
                            var n =
                                d._navigator &&
                                d._navigator.vendor.indexOf("Apple") >= 0;
                            if (
                                d._scratchBuffer &&
                                e.bufferSource &&
                        ...
                        _clearSound: function (e) {
                            /MSIE |Trident\//.test(
                                d._navigator && d._navigator.userAgent
                            ) ||
                                (e.src =
                                    "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA");
                        },
                    ...
                    l.prototype = {
                        ...
                        create: function () {
                            var e = this,
                                n = e._parent,
                                t =
                                    d._muted || e._muted || e._parent._muted
                                        ? 0
                                        : e._volume;
                            return (
                                n._webAudio
                    ...
                    var c = {},
                        f = function (e) {
                            var n = e._src;
                            if (c[n])
                                return (e._duration = c[n].duration), void h(e);
                        ...
                        A = function () {
                            if (d.usingWebAudio) {
                                ...
                                if (e && t && t < 9) {
                                    var o = /safari/.test(
                                        d._navigator &&
                                            d._navigator.userAgent.toLowerCase()
                                    );
                                    d._navigator &&
                                        !o &&
                                        (d.usingWebAudio = !1);
                        ...
                        (HowlerGlobal.prototype._pos = [0, 0, 0]),
                            ...
                            (HowlerGlobal.prototype.pos = function (e, n, t) {
                                ...
                                return o.ctx && o.ctx.listener
                                    ? ((n =
                                          "number" != typeof n ? o._pos[1] : n),
                                      (t =
                                          "number" != typeof t ? o._pos[2] : t),
                                      "number" != typeof e
                                          ? o._pos
                                          : ((o._pos = [e, n, t]),
                                ...
                                for (
                                    ...
                                    if (_) {
                                        ...
                                        (_._stereo = e),
                                            (_._pos = [e, 0, 0]),
                                            _._node &&
                                                ((_._pannerAttr.panningModel =
                                                    "equalpower"),
                                                (_._panner && _._panner.pan) ||
                                                    n(_, r),
                                                "spatial" === r
                                                    ? void 0 !==
                                                      _._panner.positionX
                            ...
                            (Howl.prototype.pannerAttr = function () {
                                ...
                                if (1 === d.length) {
                                    ...
                                    2 === d.length &&
                                        ((e = d[0]), (t = parseInt(d[1], 10)));
                                for (
                                    var _ = r._getSoundIds(t), i = 0;
                                    i < _.length;
                                    i++
                                )
